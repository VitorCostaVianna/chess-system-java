...
Validates all chess rules (e.g., legal moves, check, checkmate, castling, en passant, promotion).
Dynamic board rendering after every move.
Modular and extensible codebase.
Error handling for invalid moves.


![image](https://github.com/user-attachments/assets/9d4ff5c4-716b-4cac-81e5-6d38f789ccea)
